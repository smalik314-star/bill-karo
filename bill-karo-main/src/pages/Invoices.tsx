                        ...
                        <tr key={inv.id} className="hover:bg-gray-950/40 transition-colors">
                          ...
                          <td className="py-4 text-center pr-4 sm:pr-6">
                            <div className="flex items-center justify-center space-x-1.5">
                              ...
                              {/* Open payment module prompt */}
                              <button
                                onClick={() => setPayingInvoice(inv)}
                                className="p-2 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 hover:text-amber-300 rounded-xl transition border border-amber-500/20 cursor-pointer"
                                title="भुगतान प्रविष्टि जोड़ें (Payment)"
                              >
