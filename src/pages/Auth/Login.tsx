...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] text-gray-100 flex flex-col justify-center items-center p-4 selection:bg-amber-500 selection:text-black">
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl p-6 md:p-8 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#0B0F1A] border border-gray-800 focus:border-amber-500 text-sm text-white rounded-xl py-2.5 pl-10 pr-4 placeholder-gray-600 focus:outline-none transition-colors"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-amber-500 hover:bg-amber-600 text-[#0B0F1A] font-black py-3 rounded-xl text-xs uppercase tracking-wider transition-all shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 disabled:bg-gray-800 disabled:text-gray-400 disabled:cursor-not-allowed cursor-pointer"
          >
            {loading ? (
        ...
        <div className="relative flex py-2 items-center">
          ...
          <span className="flex-shrink mx-4 text-gray-500 text-[10px] uppercase font-mono font-bold">अथवा</span>
          <div className="flex-grow border-t border-gray-800"></div>
        </div>
        ...
        <button
          ...
          type="button"
          className="w-full bg-[#0B0F1A] hover:bg-gray-800 border border-gray-800 text-xs font-bold text-gray-200 py-3 rounded-xl flex items-center justify-center space-x-2.5 transition cursor-pointer"
        >
      ...
      <span className="text-[10px] text-gray-600 font-mono mt-8 uppercase select-none">
